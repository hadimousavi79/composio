---
title: "How Can I Use Tools and Actions With Existing Authentication?"
...
Here you need to pass the authentication parameters inside the `authConfig`. `in` is where you want to add the auth, `name` is the name of the header you want to add and `value` is the value of the header.
```javascript {10-14}
