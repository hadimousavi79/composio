---
title: "How can I use Tools directly?"
...
You can also execute Actions by passing in natural language prompts which will dynamically fill the parameters required for executing the action
<CodeGroup>
```python Python
tool_set.execute_action(
    action=Action.GITHUB_STAR_A_REPOSITORY_FOR_THE_AUTHENTICATED_USER,
